...
series["203 QC 60 sec"] = {
	tags = { "203", "60 sec", "S1", "OneMoreThing" },
	wells = Prod_203.wells,
	sequence = Sequence[60],
	start = Prod_203.start,
	finish = Prod_203.finish
}

series["203 QC 30 sec"] = {
	tags = { "203", "30 sec", "S1", "OneMoreThing" },
	wells = Prod_203.wells,
